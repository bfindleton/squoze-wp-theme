...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Theme Options', 'squoze'), __('Theme Options', 'squoze'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
?>
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
			<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'squoze' ); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'squoze' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'squoze' ) ); ?>' );" />
            <div class="clear"></div>
		</div>
	</form>
</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'squoze' ), 'updated fade' );
	...
	if ( isset( $_POST['update'] ) ) {
		...
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'squoze' ), 'updated fade' );
		return $clean;
	}
